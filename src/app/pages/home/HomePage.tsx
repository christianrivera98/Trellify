...
export const HomePage = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-fixed bg-[url('https://res.cloudinary.com/ma-cloud/image/upload/v1731373280/findy/richard-horvath-_nWaeTF6qo0-unsplash_l2ns0z.jpg')] bg-cover bg-center">
        <Hero />
        <Features2 />
        <Testimonials />
      </div>
