...
export const NavBar = () => {
    ...
    const onSubmitDemo = () => {
        ...
        dispatch(startLoginWithDemo()); // Cambia a la nueva función thunk
    };
        ...
        <nav className="font-sans top-0 h-14 w-full px-4 bg-white shadow-sm fixed border-b flex items-center justify-between">
            ...
            <div className="flex mx-auto text-base font-medium px-px m-4 space-x-4">
                ...
                <button 
                    ...
                    className="focus:ring focus:outline-none bg-black rounded-lg h-10 text-white px-px w-40 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-95 duration-300">
                    Demo
                </button>
            </div>
        </nav>
